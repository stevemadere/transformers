        ...
        **kwargs,
        ...
        if resume_from_checkpoint is not None:
            if without_checkpoint_model:
                if not self.model:
                    raise ValueError("The model to be trained must be provided to the constructor if resuming from checkpoint and suppressing loading of the model during resumption")
